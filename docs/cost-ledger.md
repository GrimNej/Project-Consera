...
| Cloudflare Worker          | Static assets plus state-free Cache API, no KV, queue, Durable Object |
...
is unavailable. GitHub Actions starts one bounded ingestion at 03:17 UTC each day. A judge can
