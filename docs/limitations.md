...
- The judging release uses one shared four-digit passkey. Rate limiting, signed sessions, HTTPS,
  exact-origin checks, CSRF protection, and narrow operations reduce abuse, but this is not
  individual identity, MFA, or enterprise account administration.
